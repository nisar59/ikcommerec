            ...
            <div class="my-md-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                        ...
                        <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{$data['category']->name}}</li>
                    </ol>
                </nav>
            </div>
            <!-- End breadcrumb -->
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 col-wd-9gdot5">
                ...
                <div class="flex-center-between mb-3">
                    <h3 class="font-size-25 mb-0">{{$data['category']->name}}</h3>
                ...
                <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
                    ...
                    <div class="d-flex">
                        <form method="get"  action="">
                            <!-- Select -->
                            <select name="order" class="js-select selectpicker dropdown-select max-width-200 max-width-160-sm right-dropdown-0 px-2 px-xl-0"
                                    data-style="btn-sm bg-white font-weight-normal py-2 border text-gray-20 bg-lg-down-transparent border-lg-down-0" onchange="this.form.submit();">
                                <option {{ request()->get('order') == 'new' ? 'selected="selected"' : '' }} value="new">Newest </option>
                                <option {{ request()->get('order') == 'old' ? 'selected="selected"' : '' }} value="old">Oldest </option>
                                <option {{ request()->get('order') == 'min' ? 'selected="selected"' : '' }} value="min">Lowest Price </option>
                                <option {{ request()->get('order') == 'max' ? 'selected="selected"' : '' }} value="max">Highest Price </option>
                            </select>
                            <!-- End Select -->
                        </form>
                        {{--<form method="get" action="" class="ml-2 d-none d-xl-block">--}}
                            {{--<!-- Select -->--}}
                            {{--<select name="limit" class="js-select selectpicker dropdown-select max-width-120"--}}
               ...
               @include('store.product.blocks.featured_products')
