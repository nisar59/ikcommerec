            ...
            <div class="container">
                <div class="d-flex align-items-center">
                    <div class="topbar-left">
                        <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Welcome to Worldwide {{config('settings.config_site_title')}} Store</a>
                    </div>
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                ...
                                @if(Auth::guard('user')->user())
                                    ...
                                    <i class="ec ec-user mr-1"></i> Welcome {{Auth::guard('user')->user()->first_name}} <span class="text-gray-50"> | <a  class="u-header-topbar__nav-link" href="{{ url('/customer/dashboard') }}">Dashbaord</a> | <a  class="u-header-topbar__nav-link" href="{{ url('/customer/orders') }}">View Orders</a> | </span> <a  class="u-header-topbar__nav-link" href="{{ route('store-logout') }}">Sign Out</a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                            <!-- Logo -->
                            <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center"  href="{{url('/')}}" aria-label="{{config('settings.config_site_title')}}">
                        ...
                        <!-- ========== HEADER SIDEBAR ========== -->
                        <!-- ========== HEADER SIDEBAR ========== -->
                    @include('store.sections.header_side_manu')
                    <!-- ========== END HEADER SIDEBAR ========== -->
                        <!-- ========== END HEADER SIDEBAR ========== -->
                    </div>
                                        ...
                                        {{--<li class="nav-item hs-has-mega-menu u-header__nav-item"--}}
                                            ...
                                            {{--<div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="pagesMegaMenu">--}}
                                                {{--<div class="row u-header__mega-menu-wrapper">--}}
                                                    {{--<div class="col-md-3">--}}
                                                        {{--<span class="u-header__sub-menu-title">Home & Static Pagesddddd</span>--}}
                    ...
                    <div class="d-none d-xl-block col-md-auto">
                        <div class="d-flex">
                            ...
                            <div class="ml-2">
                                <div class="phone">
                                    <strong>Support</strong> <a href="tel:800856800604" class="text-gray-90">{{config('settings.config_header_mobile')}}</a>
                                </div>
                                <div class="email">
                                    E-mail: <a href="mailto:{{config('settings.config_site_email')}}?subject=Help Need" class="text-gray-90">{{config('settings.config_site_email')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- End Customer Care -->
                    <!-- Header Icons -->
                   @include('store.layouts.inner_header_icons')
                    <!-- End Header Icons -->
                </div>
            </div>
        </div>
                    ...
                    <div class="col align-self-center">
                        ...
                        <form class="js-focus-state" action="{{url('search')}}" method="get">
                            ...
                            <div class="input-group">
                                <input type="text" name="keyword" class="form-control py-2 pl-5 font-size-15 border-0 height-40 rounded-left-pill" name="email" id="searchProduct" placeholder="Search for Products" aria-label="Search for Products" aria-describedby="searchProduct1" required>
                                <div class="input-group-append">
                                    ...
                                    <select name="category" class="js-select selectpicker dropdown-select custom-search-categories-select"
                                        ...
                                        @foreach($data ['manu_categories'] as $key => $asidecat)
                                            <option value="{{$asidecat->id}}"> {{$asidecat->name}}</option>
                    ...
                    <div class="col-md-auto align-self-center">
                        <div class="d-flex">
                            <ul class="d-flex list-unstyled mb-0">
                                <li class="col"><a href="{{url('compare')}}" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Compare"><i class="font-size-22 ec ec-compare"></i></a></li>
                                <li class="col"><a href="{{ route('store-wishlist') }}" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Favorites"><i class="font-size-22 ec ec-favorites"></i></a></li>
                                <li class="col pr-0">
                                    <a href="{{url('cart')}}" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        <i class="font-size-22 ec ec-shopping-bag"></i>
                                        <span class="width-22 height-22 bg-dark position-absolute flex-content-center text-white rounded-circle left-12 top-8 font-weight-bold font-size-12">{{ getCartTotalItems() }}</span>
                                        <span class="font-weight-bold font-size-16 text-gray-90 ml-3">{{config('variable.DEFAULT_CURRENCY')}}{{getCartTotal()}}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
