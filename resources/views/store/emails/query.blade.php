										...
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td class="row" style="padding:5px 20px;border: 1px solid #e3e3e3;border-radius: 4px; color: #000; direction: ltr;">
													<table cellpadding="0" cellspacing="0" width="100%">
                                                        @if(isset($data['request']['product_id']))
                                                            <tr>
                                                        ...
                                                        @endif
                                                        @if(isset($data['request']['product_title']))
                                                            <tr>
                                                                <td align="left" style="width: 100px;">
                                                                    Product Title
                                                                </td>
                                                                <td align="left" style="font-family:'Cairo', sans-serif;padding:0 10px; font-size: 13px; font-weight: 600;">
                                                                    <span style="direction: ltr; text-align: left; display: block;">
                                                                        {{ $data['request']['product_title'] }}
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        @if(isset($data['request']['product_sku']))
                                                            <tr>
                                                                <td align="left" style="width: 100px;">
                                                                    Product SKU
                                                                </td>
