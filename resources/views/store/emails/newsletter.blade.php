                            	...
                            	<tr class="tr">
                                   	<td align="left" style="color:#6C6D6D; font-size:12px; line-height:14px; font-family: 'Cairo', sans-serif;" class="col">
										@if(config('settings.config_copyright_text'))
											{!! config('settings.config_copyright_text') !!}
										@endif
									</td>
                                   	<td align="right" style="color:#6C6D6D; font-size:12px; line-height:14px; font-family: 'Cairo', sans-serif;" class="col">
										<a href="{{ route('store-newsletter-unsubscribe', ['email' => $data['newsletter_email']]) }}">Unsubscribe</a>
									</td>
                                </tr>
                            </table>
                        </td>
