...
@section('content')
    ...
    @endif
        ...
        <form class="js-validate" novalidate="novalidate"  action="{{route('store-shipping-address')}}" method="post">
            {!! Form::open(['url' => route('store-shipping-address'), 'class' => 'shipping_form']) !!}
            @if(session()->has('shipping_address'))

                <input type="hidden" autocomplete="off" name="shipping_address_id" value="{{ session()->get('shipping_address')->id }}" required/>
            @endif
                        ...
                        <div class="bg-gray-1 rounded-lg">
                            ...
                            <div class="p-4 mb-4 checkout-table">
                                ...
                                <table class="table">
                                    ...
                                    <tr class="cart_item">
                                        <td>{{ $item->name }}<strong class="product-quantity"> × {{ $item->quantity }}</strong></td>
                                        <td>{{config('variable.DEFAULT_CURRENCY')}}{{ number_format($item->quantity*$item->price,2) }}</td>
                                    </tr>
                                   @endforeach
                                    ...
                                    <tr>
                                        <th>Subtotal</th>
                                        <td>{{config('variable.DEFAULT_CURRENCY')}}{{number_format($data['cart_sub_total'],2)}}</td>
                                    </tr>
                                    {{--<tr>--}}
                                        {{--<th>Shipping</th>--}}
                                    ...
                                    <tr>
                                        <th>Total</th>
                                        <td><strong>{{config('variable.DEFAULT_CURRENCY')}}{{number_format($data['cart_total'],2)}}</strong></td>
                                    </tr>
                                    </tfoot>
                                </table>
                                <!-- End Product Content -->
                                <div class="border-top border-width-3 border-color-1 pt-3 mb-3">
                                    ...
                                    <div id="basicsAccordion1">
                                        <!-- Card -->
                                   @foreach($data['paymentsMethods'] as $key => $payment)

                                        <div class="border-bottom border-color-1 border-dotted-bottom">
                                            <div class="p-3" id="basicsHeadingOne{{$payment->id}}">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" value="{{$payment->name}}" id="stylishRadio1{{$payment->id}}" name="payment_method" @if($key==0) checked @endif>
                                                    <label class="custom-control-label form-label" for="stylishRadio1{{$payment->id}}"
                                                           data-toggle="collapse"
                                                           data-target="#basicsCollapseOnee{{$payment->id}}"
                                                           aria-expanded="true"
                                                           aria-controls="basicsCollapseOnee{{$payment->id}}">
                                                        {{$payment->name}}
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="basicsCollapseOnee{{$payment->id}}" class="collapse @if($key==0) show @endif border-top border-color-1 border-dotted-top bg-dark-lighter"
                                                 aria-labelledby="basicsHeadingOne{{$payment->id}}"
                    ...
                    <div class="pb-7 mb-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="last_name" placeholder="Wayley" aria-label="Wayley" required="" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="address_1" placeholder="470 Lucy Forks" aria-label="470 Lucy Forks" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    {{--<input type="text" class="form-control" name="city" placeholder="London" aria-label="London" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="off">--}}
                                   @php
                                   $cities =getLeopordCities();
                                     @endphp
                                    <select name="city" class="form-control js-select selectpicker dropdown-select"  required="" data-msg="Please select City." data-error-class="u-has-error" data-success-class="u-has-success"
                                            data-live-search="true"
                                            data-style="form-control border-color-1 font-weight-normal">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="post_code" placeholder="99999" aria-label="99999" required="" data-msg="Please enter a postcode or zip code." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="state" placeholder="Enter State" aria-label="State" required="" data-msg="Please enter a state." data-error-class="u-has-error" data-success-class="u-has-success">
                                    {{--<select name="state" class="form-control js-select selectpicker dropdown-select" required="" data-msg="Please select state." data-error-class="u-has-error" data-success-class="u-has-success"--}}
                                            {{--data-live-search="true"--}}
                                            {{--data-style="form-control border-color-1 font-weight-normal">--}}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="03444444444" aria-label="j03444444444" required="" data-msg="Please enter a valid Phone Number." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="card border-0">
                                <div id="shopCartHeadingFour" class="custom-control custom-checkbox d-flex align-items-center">
                                    ...
                                    <label class="custom-control-label form-label" for="shippingdiffrentAddress" data-toggle="collapse" data-target="#shopCartfour" aria-expanded="false" aria-controls="shopCartfour">
                                        Check if billing address is different than shipping
                                    </label>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="billing_first_name" placeholder="Jack" aria-label="Jack" required="" data-msg="Please enter your frist name." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="off">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="billing_last_name" placeholder="Wayley" aria-label="Wayley" required="" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="billing_company" placeholder="Company Name" aria-label="Company Name" data-msg="Please enter a company name." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <select name="billing_country" class="form-control js-select selectpicker dropdown-select" required="" data-msg="Please select country." data-error-class="u-has-error" data-success-class="u-has-success"
                                                        data-live-search="true"
                                                        data-style="form-control border-color-1 font-weight-normal">
                                                    <option value="">Select country</option>
                                                    {{--<option value="AF">Afghanistan</option>--}}
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="billing_address_1" placeholder="470 Lucy Forks" aria-label="470 Lucy Forks" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                {{--<input type="text" class="form-control" name="billing_city" placeholder="London" aria-label="London" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="off">--}}
                                                <select name="billing_city" class="form-control js-select selectpicker dropdown-select"  required="" data-msg="Please select City." data-error-class="u-has-error" data-success-class="u-has-success"
                                                        data-live-search="true"
                                                        data-style="form-control border-color-1 font-weight-normal">
                                                    <option value="">Select City</option>
                                                    @foreach($cities->city_list as $key=>$city)
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="billing_post_code" placeholder="99999" aria-label="99999" required="" data-msg="Please enter a postcode or zip code." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="billing_state" placeholder="State" aria-label="State" required="" data-msg="Please enter a state." data-error-class="u-has-error" data-success-class="u-has-success">
                                                {{--<select name="billing_state" class="form-control js-select selectpicker dropdown-select" required="" data-msg="Please select state." data-error-class="u-has-error" data-success-class="u-has-success"--}}
                                                        {{--data-live-search="true"--}}
                                                        {{--data-style="form-control border-color-1 font-weight-normal">--}}
                                                    {{--<option value="">Select state</option>--}}
                                                    {{--<option value="AF">Afghanistan</option>--}}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="email" class="form-control" name="billing_email" placeholder="jackwayley@gmail.com" aria-label="jackwayley@gmail.com" required="" data-msg="Please enter a valid email address." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" name="billing_phone" class="form-control" placeholder="+1 (062) 109-9222" aria-label="+1 (062) 109-9222" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                        ...
                        <div class="js-form-message mb-6">
                            ...
                            <div class="input-group">
                                <textarea name="order_note" class="form-control p-5" rows="4" name="text" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                            </div>
                        </div>
                        <!-- End Input -->
                    </div>
