...
@php
    ...
    use Modules\WareHouses\Entities\WareHouses as WareHouse;
    use Modules\Stores\Entities\Stores as Store;
    use App\User;
                            ...
                            <div class="col-sm-6">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb mb-0">
                                        <li class="breadcrumb-item active">Welcome to {{settingsValue('config_site_title')}} Dashboard</li>
                                    </ol>
                                </div>
                            </div>
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h4 class="font-weight-medium font-size-24">{{Order::count()}}
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Deliverd</h5>
                        <h4 class="font-weight-medium font-size-24">{{Order::where('status','0')->count()}}
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h4 class="font-weight-medium font-size-24">{{Order::where('status','1')->count()}}
                            <i class="mdi mdi-arrow-up text-success ml-2"></i></h4>
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Ware House</h5>
                        <h4 class="font-weight-medium font-size-24">{{WareHouse::count()}}
                            <i class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                        {{--<div class="mini-stat-label bg-info">--}}
                            {{--<p class="mb-0"> 00%</p>--}}
                        {{--</div>--}}
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Store</h5>
                        <h4 class="font-weight-medium font-size-24">{{Store::count()}}
                            <i class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                        {{--<div class="mini-stat-label bg-info">--}}
                            {{--<p class="mb-0"> 00%</p>--}}
                        {{--</div>--}}
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Clients</h5>
                        <h4 class="font-weight-medium font-size-24">{{User::where('user_type', 'customer')->count()}}
                            <i class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                        {{--<div class="mini-stat-label bg-info">--}}
                            {{--<p class="mb-0"> 00%</p>--}}
                        {{--</div>--}}
            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h4 class="font-weight-medium font-size-24">2436
                            <i class="mdi mdi-arrow-up text-success ml-2"></i></h4>
