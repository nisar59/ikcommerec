                          ...
                          <tr>
                            <td style="border-bottom: 1px solid #eaeaec;" width="50%">
                              <table style="margin: 10px 0;">
                                <tr>
                                  <td><a href="#"><img src="{{ url('public/uploads/images/'.settingsValue('config_site_logo'))}}" alt="" height="100"></a></td>
                                </tr>
                              </table>
                            </td>
                            <td  class="align-right" width="50%" style="text-align: -webkit-right; border-bottom: 1px solid #eaeaec; ">
                              <table style="margin: 10px 0;">
                                ...
                                <tr>
                                  <td><h2 class="align-right" style="margin-bottom: 0px; color: #777777; font-weight: normal;">{{$data['user']->shipping_from_address}}</h2></td>
                                </tr>
                                <tr>
                                  <td><h5 class="align-right" style="margin-bottom: 0px; color: #777777; font-weight: normal;">{{$data['user']->shipping_from_mbl}}</h5></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <table style="margin: 10px 0;">
                                ...
                                <tr>
                                  <td><p style="margin-bottom: 0px; color: #777777; font-size: 16px;">{{$data['user']->first_name.' '.$data['user']->last_name}}</p></td>
                                </tr>
                                <tr>
                                  <td><p style="margin-bottom: 0px; color: #777777; font-size: 16px;">{{$data['user']->billing_phone}}</p></td>
                                </tr>
                                <tr>
                                  <td><p style="margin-bottom: 0px; color: #777777; font-size: 16px;">{{$data['user']->billing_email}}</p></td>
                                </tr>
                                <tr>
                                  <td><p style="margin-bottom: 0px; color: #777777; font-weight: normal;">{{$data['user']->billing_address_1.' '.$data['user']->billing_city.' '.$data['user']->post_code.' '.$data['user']->billing_country}}</p></td>
                                </tr>
                              </table>
                            </td>
                            <td  class="align-right" style="text-align: -webkit-right;">
                              <table style="margin: 10px 0;">
                                <tr>
                                  <th><h2 class="align-right" style="margin-bottom: 0px; color: #777777;">Ship To:</h2></th>
                                </tr>
                                <tr>
                                  <td><p class="align-right" style="margin-bottom: 0px; color: #777777; font-size: 16px;">{{$data['user']->first_name.' '.$data['user']->last_name}}</p></td>
                                </tr>
                                <tr>
                                  <td><p class="align-right" style="margin-bottom: 0px; color: #777777; font-size: 16px;">{{$data['user']->ship_phone}}</p></td>
                                </tr>
                                <tr>
                                  <td><p class="align-right" style="margin-bottom: 0px; color: #777777; font-size: 16px;">{{$data['user']->ship_email}}</p></td>
                                </tr>
                                <tr>
                                  <td><p class="align-right" style="margin-bottom: 0px; color: #777777; font-weight: normal;">{{$data['user']->ship_address_1.' '.$data['user']->ship_city.' '.$data['user']->ship_state.' '.$data['user']->ship_country}}</p></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                          <tr>
                            <td colspan="2">
                              <table class="purchase_content" style="margin-top: 30px;" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                @endphp
                                <tr>
                                  <td width="10%" class="purchase_item" align="center"><span class="f-fallback">{{$i}}</span></td>
                                  <td width="22.5%" class="purchase_item"><span class="f-fallback">{{$proname}}</span></td>
                                  <td width="22.5%" class="purchase_item" align="center"><span class="f-fallback">Rs.{{$val->price}}</span></td>
                                  <td width="22.5%" class="purchase_item" align="center"><span class="f-fallback">{{$val->quantity}}</span></td>
                                  <td class="align-right purchase_item" width="22.5%" class="purchase_item"><span class="f-fallback">Rs.{{$val->total_price}}</span></td>
                                </tr>
                                @php
                                                    }
                                @endphp
                          ...
                          <tr>
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="{{url('admin/invoice/pdf/'.$data['user']->id)}}" class="f-fallback button button--blue" target="_blank">Download as PDF</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
