    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Invoices Management</h4>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ url()->previous() }}">Dashboard</a></li>

                    <li class="breadcrumb-item active">Invoices Management</li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Invoices Management</h4>
                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        @foreach ($data['orders'] as $key => $user)
                            ...
                            <tr>
                                <td>{{$user->id}}</td>
                                <td>{{config('settings.config_invoice_pre_fix')}}{{$user->id}}</td>
                                ...
                                <td>${{$user->total}} </td>
                                <td>
                                    <a href="{{ url('admin/invoice/status/'.$user->id) }}">
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-primary" href="{{ url('admin/invoice/edit/'.$user->id) }}"><i class="fas fa-eye"></i></a>

                                    {{--<form id = "sub_form" class="form-horizontal" action="{{url('admin/order/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >--}}
                                    {{--{{csrf_field()}}--}}
