...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="accountsreport">
                        @csrf
                    <select class="form-control" name="acnt" >
                    ...
                    <h4 class="card-title">Daily Cash Vouchers Report For</h4>
                    ...
                    <table id="vouchersereport" class="table table-striped ">
                        ...
                        @foreach ($data['orders'] as $key => $user)
                            ...
                            <tr>
                                <td style="border-bottom:1px solid black;">{{$user->id}}</td>
                                ...
                                <td style="border-bottom:1px solid black;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="text-align:right;">{{$user->banam}}</td>
                                        </tr>
                                        <tr>
                                ...
                                <td style="border-bottom:1px solid black;">  {{$user->amount}} </td>
                                <td style="vertical-align: middle;border-bottom:1px solid black;">  {{$user->amount}} </td>
                                <td style="text-align:center;border-bottom:1px solid black;">{{config('settings.config_voucher_pre_fix')}}{{$user->voucher_code}} </td>
    ...
    $('#vouchersereport').DataTable({
         "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 3 ).footer() ).html(
                ''+pageTotalQ +' ( '+ total +' total)'
            );
            $( api.column( 4 ).footer() ).html(
                ''+pageTotalP +' ( '+ totalprchase +' total)'
            );
