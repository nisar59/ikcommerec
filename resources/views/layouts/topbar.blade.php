                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="/dashboard" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ url('public/uploads/images/'.settingsValue('config_site_logo'))}}" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="{{url('admin/dashboard')}}" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ url('public/uploads/images/'.settingsValue('config_site_logo'))}}" alt="" height="100">
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-none d-md-block ml-2">
                            <button type="button" class="btn header-item waves-effect"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="mr-2" src="{{url('public/assets/images/flags/us_flag.jpg')}}" alt="Header Language" height="16"> English <span class="mdi mdi-chevron-down"></span>
                            </button>
                    ...
                    {{----}}
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <img class="rounded-circle header-profile-user" src="{{ url('public/uploads/images/'.settingsValue('config_site_logo'))}}"
