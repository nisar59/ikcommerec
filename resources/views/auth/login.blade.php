                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="bg-primary">
                            <div class="text-primary text-center p-4">
                                ...
                                <a href="index" class="logo logo-admin">
                                    <img src="{{ url('public/uploads/images/'.settingsValue('config_site_logo'))}}" height="24" alt="logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-4">
                            <div class="p-3">
                            <form class="form-horizontal mt-4" method="POST" action="{{ url('admin/login') }}">
                                @csrf
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Websouls.com</p>
                    </div>
