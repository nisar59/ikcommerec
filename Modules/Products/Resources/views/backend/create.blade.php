                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body">
                       <span class="repeater">
                        ...
                        <input type="number" name="quantitys" class="form-control">
                            </div>

                            <div  class="form-group col-lg-4">
                                <label for="warehouse_id">Ware house</label>
                                {!! Form::select('warehouse_ids', $data['warehouses'],[], array('class' => 'form-control' ,'id'=>"warehouse_id")) !!}
                            </div>
                      ...
                      @foreach($data['Variation'] as $val)
                        <div  class="form-group col-lg-3">
                          ...
                          @if($val->id==$vval->variation_id)
                               <option value="{{$vval->id}}">{{$vval->value}}</option>
                            @endif
                            @endforeach
