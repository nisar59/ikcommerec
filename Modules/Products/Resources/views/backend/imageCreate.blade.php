        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">{{$data['product']->name}}'s Images </h4>
                    {{--<p class="card-title-desc">DataTables has most features enabled by--}}
                    {{--default, so all you need to do to use it with your own tables is to call--}}
                    {{--the construction function: <code>$().DataTable();</code>.--}}
                    {{--</p>--}}

                    {!! Form::open(array('url' => 'admin/products/images/store/'.$data['product']->id,'method'=>'POST', "enctype"=>"multipart/form-data")) !!}
                    <div class="row">
