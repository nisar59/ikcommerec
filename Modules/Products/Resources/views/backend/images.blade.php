        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {{--</p>--}}
                   @if($data['user']->count() < 5)
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ url('admin/products/images/create/'.$data['product']->id) }}"> Create New Image</a>
                    </div>
                   @endif
                        ...
                        @foreach ($data['user'] as $key => $user)
                            ...
                            <tr>
                                ...
                                <td>
                                      ...
                                      <img src="{{url('public/uploads/products/'.$user->images)}}" width="100">
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/products/images/edit/'.$user->id) }}"><i class="fas fa-edit"></i></a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('admin/products/images/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
