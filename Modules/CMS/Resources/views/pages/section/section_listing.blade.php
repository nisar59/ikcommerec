                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="page-title-box col-sm-1" style="text-align: right;">
                                        <button  class="btn btn-primary" id="show" onclick="show_form()"> Add Section </button>     
                                        <button  class="btn btn-primary" id="hide" onclick="show_form()" style="display: none;"> Hide Form </button>      
                                    </div>
                                   
                                             
                                   
                                    {{-- <div class="page-title-box col-sm-1" style="float: right">
                                    <a href="{{url('cms/page')}}" > <button  class="btn btn-primary"  > Back </button>  </a>     
                                    </div> --}}
                                </div>
                                </div>

                                <div class="col-sm-12" style="display:none" id="show_form" >
                                    <form action="{{url('admin/cms/section_add')}}" method="POST" enctype="multipart/form-data" >
                                        @csrf
                                        ...
                                        <table id="datatable" class="table table-striped ">
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm mt-2" role="group" aria-label="Basic example">
                                                    <a href="{{url('admin/cms/subsection/'.$section->id)}}">   <button type="button" class="btn btn-secondary">Sub Section</button> </a>
                                                    <a href="{{url('admin/cms/edit_section/'.$section->id)}}" >  <button type="button" class="btn btn-secondary">Edit</button> </a>
                                                <a href="{{url('admin/cms/delete_section/'.$section->id)}}">    <button type="button" class="btn btn-secondary">Delete</button> </a>
                                                </div>
                                            </td>
                                            </tr>
                                           @endforeach
