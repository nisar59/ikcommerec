...
@section('content')
        ...
        <div class="col-sm-6">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Products Variation Value Update </li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
            <form method="POST" action="{{url('admin/variations/values/update/'.$data->id)}}">
                @csrf
                <h4 class="card-title">Products Variation Value Update</h4>
             <!-- Nav tabs -->
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>value:</strong>
                                  <input type="text" name="value" value="{{$data->value}}" class="form-control" required>
                                  <input type="hidden" name="variation_id" value="{{$data->variation_id}}" class="form-control" required>
                                </div>
                            </div>
                            </div>
                        </div>
