            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ url('courses/faqs/create/'.$data['course']->id) }}"> Create New FAQ</a>
                    </div>
                        ...
                        @foreach ($data['user'] as $key => $user)
                           ...
                           // dd($user->course_reviews)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('courses/faqs/statusUpdate/'.$user->id) }}">
                                        @if($user->status==1)
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('courses/faqs/edit/'.$user->id) }}">Edit</a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('courses/faqs/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
