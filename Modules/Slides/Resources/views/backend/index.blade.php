    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Banners Management</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ url('admin/slides/create') }}"> Create New Banner</a>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        @foreach ($data['user'] as $key => $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/slides/statusUpdate/'.$user->id) }}">
                                        @if($user->status==1)
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/slides/edit/'.$user->id) }}"><i class="fas fa-edit"></i></a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('admin/slides/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
