    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Banner Management</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($data['user'], ['method' => 'POST','url' => ['admin/slides/update/'.$data['user']->id],"enctype"=>"multipart/form-data"]) !!}
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>URL:</strong>
                                {!! Form::text('ex_url', null, array('placeholder' => 'URL','class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                @if(!empty($data['user']->image))
                                    <img src="{{url('public/uploads/banners/'.$data['user']->image)}}"  width="150" />
                                    <br><br><br>
                                 @endif
