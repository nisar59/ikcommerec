            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ url('admin/suppliers/create') }}"> Create New Store</a>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped " >
                        ...
                        @foreach ($data['user'] as $key => $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/suppliers/statusUpdate/'.$user->id) }}">
                                        @if($user->status==1)
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/suppliers/edit/'.$user->id) }}"><i class="fas fa-edit"></i></a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('admin/suppliers/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
