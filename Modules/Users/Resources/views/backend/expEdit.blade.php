    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">{{$data['user']->first_name}} {{$data['user']->last_name}}'s Experience  Management</h4>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>

                    <li class="breadcrumb-item active">Experience Management</li>
                </ol>
            </div>
        </div>
        @if (count($errors) > 0)
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Edit User's Experience </h4>
                    {{--<p class="card-title-desc">DataTables has most features enabled by--}}
                    {{--default, so all you need to do to use it with your own tables is to call--}}
                    {{--the construction function: <code>$().DataTable();</code>.--}}
                    {{--</p>--}}

                    {!! Form::model($data['user'], ['method' => 'POST','url' => ['users/instructors/exp/update/'.$data['user']->id], "enctype"=>"multipart/form-data"]) !!}
                    <div class="row">
