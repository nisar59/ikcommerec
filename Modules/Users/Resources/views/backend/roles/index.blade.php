    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Roles Management</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ url('admin/users/role/create') }}"> Create New Role</a>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        @foreach ($data['roles'] as $key => $role)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/users/role/edit/'.$role->id) }}"><i class="fas fa-edit"></i></a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('admin/users/role/destroy/'.$role->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
