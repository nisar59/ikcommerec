    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Instructor Management</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($data['user'], ['method' => 'POST','url' => ['users/instructors/update/'.$data['user']->id], "enctype"=>"multipart/form-data"]) !!}
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                @if(isset($data['user']->profile_picture))
                                    <img src="{{url('public/uploads/profile_pictures/'.$data['user']->profile_picture)}}" width="128"  height="128">
                                    <br>
                                @endif
