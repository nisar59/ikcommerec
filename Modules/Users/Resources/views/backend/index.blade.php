                        ...
                        <table id="datatable" class="table table-striped " >
                            ...
                            <tr>
                                ...
                                <td> @if(!empty($user->getRoleNames()))
                                    ...
                                    @endif</td>
                                <td>
                                 <a href="{{ url('admin/users/statusUpdate/'.$user->id) }}">
                                  @if($user->status==1)
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/users/edit/'.$user->id) }}"><i class="fas fa-edit"></i></a>
                              <form id = "sub_form" class="form-horizontal" action="{{url('admin/users/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                {{csrf_field()}}
