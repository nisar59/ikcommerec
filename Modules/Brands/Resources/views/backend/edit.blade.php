    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Brands Management</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($data['user'], ['method' => 'POST', "enctype"=>"multipart/form-data",'url' => ['admin/brands/update/'.$data['user']->id]]) !!}
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('description', null, array('placeholder' => 'Short Description','class' => 'summernote')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                @if(!empty($data['user']->image))
                                    <img src="{{url('public/uploads/brands/'.$data['user']->image)}}"  width="150" />
                                    <br><br><br>
                                @endif

                                <strong>Image: (200 * 60)</strong>
                                {!! Form::file('image', null, array('placeholder' => 'Upload Brand Image','class' => 'form-control filestyle')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    {!! Form::textarea('meta_schema', null, array('placeholder' => 'Schema','class' => 'form-control')) !!}
                                </div>
                            </div>
