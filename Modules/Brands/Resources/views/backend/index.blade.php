                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        @foreach ($data['user'] as $key => $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/brands/statusUpdate/'.$user->id) }}">
                                        @if($user->status==1)
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/brands/edit/'.$user->id) }}"><i class="fas fa-edit"></i></a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('admin/brands/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
