    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Payment Methods</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-success" href="{{ url('admin/paymentsmethods/create') }}"> Create New Payment Method
                        </a>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped " >
                        ...
                        @foreach ($data['user'] as $key => $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/paymentsmethods/statusUpdate/'.$user->id) }}">
                                        @if($user->status==1)
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/paymentsmethods/edit/'.$user->id) }}"><i class="fas fa-edit"></i></a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('admin/paymentsmethods/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
