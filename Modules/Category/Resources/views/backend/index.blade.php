                        ...
                        @foreach ($data['user'] as $key => $user)
                            ...
                            <tr>
                               ...
                               <td><a href="{{ url('admin/categories/subcats/'.$user->id) }}">
                                ...
                                <td>
                                    <a href="{{ url('admin/categories/statusUpdate/'.$user->id) }}">
                                        @if($user->status==1)
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ url('admin/categories/edit/'.$user->id) }}"><i class="fas fa-edit"></i></a>
                                    <form id = "sub_form" class="form-horizontal" action="{{url('admin/categories/destroy/'.$user->id)}}" method="POST" enctype="multipart/form-data"  >
                                    {{csrf_field()}}
